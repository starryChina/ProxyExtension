    ...
    if (e.state === "enabled") {
      ...
      if (e.devices) {
        ...
        if (!script.a) {
          ...
          script.a.src = chrome.runtime.getURL("data/media_devices.js");
          /*  */
      ...
      if (e.inject) {
        ...
        if (!script.b) {
          ...
          script.b.src = chrome.runtime.getURL("data/support_detection.js");
          /*  */
      ...
      if (e.additional) {
        ...
        if (!script.c) {
          ...
          script.c.src = chrome.runtime.getURL("data/additional_objects.js");
          /*  */
